...
import com.example.worldcupquiz.LeaderFragment.GetLeaderBoard;
import com.example.worldcupquiz.LeaderFragment.GetTopLeader;
...
public class TopScorer extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = View.inflate(getActivity(), R.layout.top_score, null);
	...
	public class GetTopLeader extends AsyncTask<Void, String, String> {
		...
		protected void onPreExecute() { // TODO Auto-generated method stub
			super.onPreExecute();
			Progress.setMessage("Fetching Leader Board...");
			Progress.setCancelable(false);
			Progress.show();
		}
	...
	public void setUserVisibleHint(boolean isVisibleToUser) {
		...
		if (isVisibleToUser) {
			...
			if (DetectConnection.checkInternetConnection(Constants.context)) {
				...
				GetTopLeader gt = new GetTopLeader();
				gt.execute();
